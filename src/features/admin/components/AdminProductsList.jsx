    ...
    <div className="lg:col-span-5">
      <div>
        <Link
          ...
          className="rounded-md mx-8 my-4 bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
        >
          Add New Product
        </Link>
      </div>
            ...
            {products.map((product) => (
              <div key={product.id}>
                <Link to={`/productDetail/${product.id}`}>
                  <div
                    className="hover:scale-105 transition-all shadow-md p-2 rounded
             group relative"
                  >
                    <div className="max-h-[300px] aspect-h-1 aspect-w-1 w-full overflow-hidden rounded-md bg-gray-200 lg:aspect-none lg:h-64">
                      <img
